public class BankTest {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\nexpecting account summaries to match \n Input - First Name: Corwin, Last Name: Bell, Account ID: 2, Balance: $0.00, Interest Rate: 8.50% \nOutput - " + myCheckingAccount.accountSummary());

        // test deposit functionality
        myCheckingAccount.deposit(10);
        System.out.printf("\nexpecting post-deposit balance to be $10.00, got $%.2f\n", myCheckingAccount.getBalance());
        try {
            myCheckingAccount.deposit(-50);
            System.out.println("\nexpecting deposit error message for -50, got none");
        }
        catch (Exception e) {
            System.out.println("\nexpecting deposit error message for -50, got " + e.getMessage());
        }
        // test withdrawal functionality 
        myCheckingAccount.withdrawal(10);
        System.out.printf("\nexpecting post-withdrawal balance to be $0, got $%.2f\n", myCheckingAccount.getBalance());
        try {
            myCheckingAccount.withdrawal(-50);
            System.out.println("\nexpecting withdrawl error message for -50, got none");
        }
        catch (Exception e) {
            System.out.println("\nexpecting withdrawl error message for -50, got " + e.getMessage());
        }
        ...
        System.out.printf("\nexpecting overdraft withdrawal to be $%.2f, got $%.2f\n", overdraftTest, myCheckingAccount.getBalance());
        try {
